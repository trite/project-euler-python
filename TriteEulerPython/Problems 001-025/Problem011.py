print('In the 20x20 grid below, four numbers along a diagonal line have been marked in red.')
...
print('''The product of these numbers is 26 x 63 x 78 x 14 = 1788696.
